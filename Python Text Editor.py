...
menu_bar = Menu(root)
file_menu = Menu(menu_bar, tearoff=False, activebackground='Blue')
...
edit_menu = Menu(menu_bar, tearoff=False, activebackground='Blue')
...
help_menu = Menu(menu_bar, tearoff=False, activebackground='Blue')
